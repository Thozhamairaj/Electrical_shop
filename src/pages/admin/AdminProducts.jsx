...
export default function AdminProducts() {
    ...
    const loadProducts = useCallback(() => {
        setLoading(true);
        authFetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/products`)
    ...
    const handleDelete = async (id) => {
        try {
            const res = await authFetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/products/${id}`, { method: 'DELETE' });
